...
class VehicleModel {
  ...
  factory VehicleModel.fromJson(Map<String, dynamic> json) {
    ...
    return VehicleModel(
      id: _str(json['id'] ?? json['vehicle_id']) ?? '',
      serialNumber: _str(json['serialNumber'] ?? json['chassis_number']),
      make: _str(json['make']),
      model: _str(json['model']),
      chassisModel: _str(json['chassisModel'] ?? json['chassis_model']),
      cc: _str(json['cc'] ?? json['veh_cc']),
      year: _str(json['year'] ?? json['veh_year']),
      color: _str(json['color'] ?? json['veh_color']),
      vehicleBuyDate: _str(json['vehicleBuyDate'] ?? json['veh_buy_date']),
      auctionShipNumber:
          _str(json['auctionShipNumber'] ?? json['veh_auc_ship_number']),
      netWeight: _str(json['netWeight'] ?? json['veh_net_weight']),
      area: _str(json['area']),
      length: _str(json['length'] ?? json['veh_l']),
      width: _str(json['width'] ?? json['veh_w']),
      height: _str(json['height'] ?? json['veh_h']),
      plateNumber: _str(json['plateNumber'] ?? json['plate_number']),
      buyingPrice: _str(json['buyingPrice'] ?? json['veh_buy_price']),
      expectedYardDate:
          _str(json['expectedYardDate'] ?? json['yard_date_in']),
      riksoFrom: _str(json['riksoFrom'] ?? json['rikso_from_place_id']),
      riksoTo: _str(json['riksoTo'] ?? json['rikso_to_place_id']),
      riksoCost: _str(json['riksoCost'] ?? json['rikso_cost']),
      riksoCompany: _str(json['riksoCompany'] ?? json['rikso_company']),
      images: images,
      auctionSheet: _str(json['auctionSheet'] ?? json['auction_sheet']),
      tohonCopy: _str(json['tohonCopy'] ?? json['tohon_copy']),
